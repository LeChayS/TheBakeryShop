...
INSERT INTO detailBill VALUES(1,'BN001',10,null,20000);
INSERT INTO detailBill VALUES(2,'BM002',5,null,50000);
INSERT INTO detailBill VALUES(3,'SN003',15,null,100000);
INSERT INTO detailBill VALUES(4,'TM004',20,null,150000);
INSERT INTO detailBill VALUES(5,'BN005',2,null,20000);
...
(
  ...
  codeType CHAR(5) NOT NULL,
  PRIMARY KEY (codePro),
  FOREIGN KEY (codeType) REFERENCES style(codeType)
);
